 ...
 */
    ...
    private void initComponents() {
        ...
        panelTipoDespesa = new JPanel();
                ...
                panelTipoDespesa.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Tipo de despesa", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));
        ...
        panelDespesas.add(btnExcluirDespesa);
                ...
                panelDespesas.add(scrollPane);
                        ...
                        table.setModel(new DefaultTableModel(
                            ...
                            new String[] {
                                "Categoria", "Despesa","Data inicial", "Mensal", "Ocasional", "Total Anual"
                            }
                        ));
    ...
    protected void btnExcluirActionPerformed() {
		 int coluna = table.getSelectedRow();
	        ...
	        int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir o fundo: " + despesa.getDespesa() + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
	...
	protected void btnEditarDespesaActionPerformed() {
        ...
        if (coluna == -1) {
            JOptionPane.showMessageDialog(this, "Selecione uma despesa para editar.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        Despesa despesa = despesas.get(coluna);
        
        int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente editar a despesa: " + despesa.getDespesa() + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
